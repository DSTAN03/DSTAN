...
class TdAppBar extends StatelessWidget implements PreferredSizeWidget {
  const TdAppBar({
    ...
    required this.title,
    this.avatar,
    this.color = const Color.fromARGB(255, 244, 58, 58),
  });
        ...
        children: [
          GestureDetector(
            ...
            child: Transform.rotate(
              ...
              Shimmer.fromColors(
                baseColor: const Color.fromARGB(255, 130, 58, 218),
          ...
          // Text(
          //   title,
          //   style:  TextStyle(color: AppColor.primary, fontSize: 24.6),
          // ),
          GestureDetector(
            onTap: rightPressed,
            child: TdAvatar(avatar: avatar, isActive: true), // link avatar lấy từ main page qua
          ),
        ],
      ),
    );
